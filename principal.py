...
def mostrar_principal():
    ...
    if rol == "admin":
        ...
        if st.button("Gestión de Alumnos"):
            ...
            st.rerun()
        if st.button("Gestión de Profesores"):
            st.session_state["pantalla_actual"] = "menuadminprofesor"
            st.rerun()
    elif rol == "empleado":
        ...
        if st.button("Gestión de Libros"):
            ...
            st.rerun()
        if st.button("Gestión de Préstamos"):
            st.session_state["pantalla_actual"] = "menuprestamos"
            st.rerun()
    elif rol == "usuario":
